                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="pricing">
                            ...
                            <div class="pricing_footer">
                                <a onclick="return ChoosePakeage(1)" class="btn btn-success btn-block" role="button" data-dismiss="modal">เลือก แพ็คเกจ นี้</a>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="pricing">
                            ...
                            <div class="pricing_footer">
                                <a onclick="return ChoosePakeage(2)" class="btn btn-success btn-block" role="button" data-dismiss="modal">เลือก แพ็คเกจ นี้</a>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="pricing ui-ribbon-container">
                            ...
                            <div class="pricing_footer">
                                <a onclick="return ChoosePakeage(3)" class="btn btn-primary btn-block" role="button" data-dismiss="modal">เลือก แพ็คเกจ นี้</a>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="pricing">
                            ...
                            <div class="pricing_footer">
                                <a onclick="return ChoosePakeage(4)" class="btn btn-success btn-block" role="button" data-dismiss="modal">เลือก แพ็คเกจ นี้</a>
                            </div>
                            </div>
                        </div>
                        </div>
