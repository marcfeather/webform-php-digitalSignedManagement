                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add Device Group</h4>
                            </div>
                                ...
                                <form class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                            Content Data<span class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div class="modal-footer">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button id="btnDelDeviceGroup" type="button" class="btn btn-danger" style="float: left; display: none;">Delete</button>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button id="btnSaveDeviceGroup" type="button" class="btn btn-primary" style="float: right;">Save changes</button>
                ...
                <table id="datatable-deviceGroup" class="table table-striped table-bordered" cellspacing="0" style="width: 100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left" style="width: 50%">Group Name</th>
                            <th class="text-left" style="width: 35%">Content</th>
