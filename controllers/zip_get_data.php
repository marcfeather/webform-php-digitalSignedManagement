...
// $sql = "SELECT content_id, content_order, CONCAT(content_name, '.',content_extension) as contentName, content_datetime FROM contents WHERE content_extension = 'zip' ORDER BY content_order";
